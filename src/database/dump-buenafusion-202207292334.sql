...
INSERT INTO `rolusers` VALUES (1,'Usuario'),(2,'Administrador');
...
CREATE TABLE `users` (
  ...
  CONSTRAINT `users_FK` FOREIGN KEY (`roluser_id`) REFERENCES `rolusers` (`id`)
...
INSERT INTO `users` VALUES (49,'Admin','Admin','1905-04-03',1133500257,'admin@live.com','$2a$10$sHPMS3BKgLKXG6YzgD860uhLDnQl03kRQI12MaBGXtqjLXrXDiHFi','avatar.jpg',1);
...
-- Dump completed on 2022-07-29 23:34:25
